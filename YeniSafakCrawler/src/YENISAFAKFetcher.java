...
public class YENISAFAKFetcher extends PooledMessageWorker {
	
	private int id;

	private static final Logger logger = Logger.getLogger(YENISAFAKFetcher.class);
	
	public YENISAFAKFetcher(int id){
		setId(id);
	}
	
	@Override
	public void run() {
		for (KoseYazari koseYazari : YENISAFAK.yazarlar) {
